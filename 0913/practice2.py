...
# 設定推播目標
TARGET_USER_ID = 8987728689               # 個人 (正整數，用戶需先私訊過 Bot)
TARGET_GROUP_ID = -5120876620         # 群組 (負整數，Bot 需在群組內)
TARGET_CHANNEL_ID = -1003636710606      # 頻道 (公開填 @帳號，Bot 需為管理員)
...
async def main():
    ...
    keyboard = InlineKeyboardMarkup([
        [
            InlineKeyboardButton("🛍️ 立即下單", url="https://t.me/+q6-sPOTR4H8xMzhl"),
            InlineKeyboardButton("💬 聯絡店長", url="https://t.me/+q6-sPOTR4H8xMzhl")
        ]
    ])
